...
public class HotelController {
    ...
    public Reservation updateReservation(@PathVariable int id, @Valid @RequestBody Reservation myReservation) throws ReservationNotFoundException {
    	return reservationDAO.update(myReservation, id);
    }
