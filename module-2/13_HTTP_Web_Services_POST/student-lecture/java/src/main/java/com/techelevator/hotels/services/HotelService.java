...
public class HotelService {
	...
	public Reservation addReservation(String newReservation) {
		...
		try {
			result = restTemplate.postForObject("http://localhost:3000/reservations", entity, Reservation.class);
	...
	public Reservation updateReservation(String CSV) {
		...
		try {
			restTemplate.put("http://localhost:3000/reservations/" + myReservation.getId(), entity);
