...
public class App {
    ...
    private static void run() {
        ...
        while(menuSelection != 0) {
            ...
            System.out.println("");
            if (menuSelection == 1) {
            	Hotel[] allHotels = hotelDao.getAllHotels();
                ...
                Review[] allReviewsForHotelOne = reviewDao.getAllReviewsForHotel(1);
                printReviews(allReviewsForHotelOne);
            } else if (menuSelection == 5) {
                Hotel[] hotelsWith3Stars = hotelDao.getHotelsByStarRating(3);
