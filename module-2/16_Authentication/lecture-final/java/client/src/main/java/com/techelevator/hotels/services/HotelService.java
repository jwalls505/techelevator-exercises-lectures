...
public class HotelService {
  ...
  public Reservation addReservation(String newReservation) throws HotelServiceException {
    ...
    try {
    	...
    	ResponseEntity<Reservation> response = restTemplate.exchange(BASE_URL + "hotels/" + reservation.getHotelID() + "/reservations", HttpMethod.POST, entity, Reservation.class);
